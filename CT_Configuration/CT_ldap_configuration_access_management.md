...
| USER DN FIELD | dn | For username. |
| USER ID FIELD | uid | For User ID. |
...
> --bind-dn "cn=admin,dc=openldap,dc=home" --user-dn-field dn --user-id-field uid --search-filter "(objectClass=person)" \
> --group-base-dn "ou=group,dc=openldap,dc=home" --group-search-filter "(objectClass=posixGroup)" --group-id-field cn \
> --root-ca-files labroot.pem:labissuer.pem --bind-password <LDAP_BIND_PASSWORD>
</pre>
        ...
        "resources": [
                {
                        ...
                        "options": {
                                ...
                                "root_cas": [
                                        ...
                                        "-----BEGIN CERTIFICATE-----\nMIIEEzCCAvugAwIBAgIIEuijT7cKRX0w87NDN7CWAdRS8Aq56qHOA7KCLaJ1mw7Uoj4\n-----END CERTIFICATE-----\n"
                                ]
                        },
                        "inherited_from": {},
                        "id": "34332989-d30f-495d-aab3-6eb2ac8635e2",
                        "created_at": "2025-04-23T21:57:19.168110+00:00",
                        "updated_at": "2025-04-23T21:57:19.168110+00:00"
                }
        ]
}
</pre>
...
<pre>
sampaul@ct-ub2204:~$ ksctl connections delete --id "34332989-d30f-495d-aab3-6eb2ac8635e2"
</pre>
